...
If you're using Leiningen, then add `[camel-snake-kebab "0.4.2"]` to your `project.clj` `:dependencies`.

For [deps](https://clojure.org/guides/deps_and_cli), use `{camel-snake-kebab {:mvn/version "0.4.2"}}`.
